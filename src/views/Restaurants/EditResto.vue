...
export default {
  ...
  created() {
      this.temp = this.$store.getters['restaurants/restaurants'].find(restaurant => parseInt(restaurant.id) === parseInt(this.id))
      this.resto.name = this.temp.name
      this.resto.address = this.temp.address
      this.resto.city = this.temp.city
  },
  methods: {
    submit () {
      this.resto.restaurateurId = parseInt(this.$session.get('user').id)
      this.$refs.observer.validate()
      let restaurant = this.resto
