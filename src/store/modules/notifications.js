...
const actions = {
    ...
    addOrderInDelivery(store, { order, username }) {
        let notification = {
            'title' : 'Votre commande ' + order.id + ' a été récupérée par le livreur',
            'description' : 'Votre commande ' + order.id + ' chez ' + order.Restaurant.name + ' a été récupérée par ' + username,
            'userId' : order.userId,
            'url' : '/my-orders',
        }
